...
export function transformBasicPost(post) {
  ...
  const postAtts = {
    ...
    isBetterSolution: post.is_better_solution,
    ...
    user_profession: post.user_profession,
    ...
    canEditWiki: post.can_edit_wiki,
    showLike: false,
    liked: false,
    canToggleLike: false,
    likeCount: false,
    ...
    best_solutions_wiki: post.best_solutions_wiki,
